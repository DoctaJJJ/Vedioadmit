...
class Analyzer():
    ...
    def control_add(self, code, algorithmCode, classNames,objectCode, recognitionRegion, minInterval,classThresh,overlapThresh,streamUrl,pushStream,pushStreamUrl):
